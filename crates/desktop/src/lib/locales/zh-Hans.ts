...
const zhHans: typeof en = {
	...
	showingLatestEntries: "显示最新 {{shown}} / {{total}} 条",
	diagnosticLogs: "诊断日志",
	...
	updateReadyRestart: "更新已安装 —— 重新启动即完成",
	...
	skillCheckScheduleHeading: "定期检查 skill 更新",
	skillCheckScheduleDescription:
		"每天 09:00 在应用关闭时运行 `aghub-cli check skills --online`，不会自动套用更新。",
	skillCheckScheduleNeedCli:
		"需要安装 aghub-cli（或将其加入 PATH）才能启用定期检查。",
	skillCheckScheduleEnabled: "已启用定期 skill 检查",
	skillCheckScheduleDisabled: "已关闭定期 skill 检查",
	skillCheckScheduleError: "无法更新 skill 检查排程",
	skillCheckScheduleCliPathLabel: "aghub-cli 路径",
	skillCheckScheduleCliPathPlaceholder: "/usr/local/bin/aghub-cli",
	skillCheckScheduleCliPathSave: "使用这个路径",
	skillCheckScheduleCliPathSaved: "已存下 aghub-cli 路径",
	skillCheckScheduleNever: "尚未跑过后台检查。",
	skillCheckScheduleNeedsAuth:
		"{{count}} 个私有来源被略过：排程只读 GIT_PASSWORD／GITHUB_TOKEN，读不到桌面 keyring。",
	skillCheckScheduleLast:
		"上次检查：{{available}} 个可更新，{{failed}} 个失败（{{when}}）",
	onboardingSkip: "跳过",
	onboardingBack: "返回",
	onboardingNext: "下一步",
	...
	removeTag: "移除标签「{{tag}}」",
	editTagsFor: "「{{name}}」的标签",
	editTagsForSelection: "已选 {{count}} 个技能的标签",
	manageAgents: "管理代理",
	...
	sourceUncheckable: "无法检查此来源",
	sourceUncheckableHint:
		"没有进行任何比对，因此下方的技能状态都不是最新的。原因：{{reason}}。",
	...
	bulkManageGroupAgents: "管理此来源的代理",
	bulkManageGroupAgentsHint:
		"对 {{source}} 下全部 {{count}} 个 skill 批量加入或移除代理。",
	bulkAgentsApply: "应用",
	bulkAgentsApplying: "应用中… {{done}}/{{total}}",
	bulkAgentsConfirmRemoveTitle: "确定移除代理？",
	...
	coverage: "覆盖",
	coverageDescription: "查看并管理每个技能与 MCP 服务器安装在哪些代理上。",
	coverageEmpty: "目前没有技能或 MCP 服务器可显示。",
	coverageSelectProject: "选择一个项目以查看其技能覆盖。",
	...
	skillLayoutMigrateExplain:
		"不会删除任何东西:每个技能当前的副本都会保留在一旁,随时可以取回。没有自己技能文件夹的 agent 仍会共用同一个目录,清单如下。",
	...
	skillLayoutSummaryLinked:
		"{{count}} 个技能将补上 {{links}} 个各自的 agent 链接,内容不会移动。",
	skillLayoutSummaryLinkedDone:
		"{{count}} 个技能已补上 {{links}} 个各自的 agent 链接,内容没有移动。",
	skillLayoutLinkedAndTidied:
		"已为 {{linked}} 个技能补上链接;其中 {{tidied}} 个同时移除了失效链接。",
	...
	skillLayoutMigrateFailed:
		"迁移中途停止:{{message}}。部分技能可能已经搬完,重新打开这个窗口看看还剩下哪些。",
	...
	skillRepairOutcome_done_migrated: "已迁移",
