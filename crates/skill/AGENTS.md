...
| Folder content hash        | `src/hash.rs`            | npx-compatible SHA-256 (golden: `tests/hash_parity_golden.rs`). Same file also owns `compute_skill_folder_comparison_hash` (skill-update's compare basis) and `collect_skill_files` |
