...
| `bc827425`         | `5c1141f9`  | desktop     | JetBrains AI icon: `agent-icons.tsx` keys the glob by `${id}.svg` but the asset is `jetbrains_ai.svg`. The only id in the roster with that mismatch; AGENTS.md step 8 had recorded it as a live bug for releases                                                                                                                                                                                                                                                                                                  |
